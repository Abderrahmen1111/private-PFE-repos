...
export function LoginForm() {
  ...
  const handleMagicLink = async (e: React.FormEvent) => {
    ...
    setMagicSent(true);
    console.log('Magic link sent to:', loginData.email);
  };
          ...
          {!magicSent ? (
            <form onSubmit={handleMagicLink} className="space-y-4">
              <div className="flex items-start gap-2.5 p-3 rounded-xl bg-primary/5 border border-primary/10 text-sm text-muted-foreground">
                ...
                <span>Enter your email and we'll send you a secure sign‑in link — no password needed.</span>
              </div>
            ...
            <div className="text-center py-4 space-y-3">
              ...
              <button
                type="button"
                onClick={() => { setMagicSent(false); setLoginData({ email: '', password: '' }); }}
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-1.5">
                ...
                <div className="group relative flex items-center">
                  ...
                  <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 hidden group-hover:flex w-52 z-10 pointer-events-none">
                    <div className="bg-popover border border-border text-popover-foreground text-xs rounded-lg px-3 py-2 shadow-lg text-center leading-relaxed">
                      Password is optional — switch to the{' '}
                      <span className="font-semibold text-primary">Magic Link</span> tab for a faster,
