    ...
    >
      ...
      >
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-blue-50 px-6 pt-8 pb-6 text-center border-b border-slate-100">
          ...
          <h2 className="text-xl font-bold text-slate-800 mb-1">Reservation Confirmed! 🎉</h2>
          <p className="text-sm text-slate-500">Your spot has been successfully reserved.</p>
        </div>
        ...
        <div className="px-6 py-5 space-y-3">
          ...
          <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-blue-50 border border-blue-100">
            <span className="text-xs text-blue-600 font-medium">Confirmation #</span>
